...
MAX_WORKERS_CHECK = 200  # Потоки для проверки прокси
MAX_WORKERS_SCRAPE = 30 # Потоки для скачивания списков
TIMEOUT = 10           
API_RETRIES = 2
...
BANNED_ISP_REGEX = r"(?i)(hetzner|cloudflare|pq hosting|contabo|digitalocean|amazon|google|the constant company|microsoft|oracle)"
